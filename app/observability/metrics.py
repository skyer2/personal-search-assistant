...
class InProcessMetrics:
    ...
    def render_prometheus(self) -> str:
        ...
        mapping = [
            ...
            ("harness.supervisor.iteration", "harness_live_supervisor_iterations_total", "Supervisor decisions started"),
            ("harness.supervisor.recovered", "harness_live_supervisor_recovered_total", "Supervisor actions that closed coverage gaps"),
            ("harness.supervisor.waste", "harness_live_supervisor_waste_total", "Iterated runs that still failed"),
