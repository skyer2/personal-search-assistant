...
# Bump when the summary projection contract changes.  Without this marker a
# deployment can reuse a summary generated by an older runtime as long as the
# event count is unchanged.
SUMMARY_PROJECTION_VERSION = "trace-summary-v2"
...
def load_summary_projection(session_id: str, *, run_id: str) -> dict[str, Any]:
    ...
    if (
        cached is not None
        and cached.get("projection_version") == SUMMARY_PROJECTION_VERSION
