...
_TYPE_ALIASES: dict[str, str] = {
    ...
    "provider_connection_error": "connection_error",
    ...
    "tool_call_cap": "budget_exhausted",
    "run_token_cap": "budget_exhausted",
    "research_phase_token_cap": "budget_exhausted",
    "run_llm_call_cap": "budget_exhausted",
    "invalid_output": "invalid_output",
    "invalid_structured_output": "invalid_output",
    "invalid_structured_worker_result": "invalid_output",
    "no_content": "invalid_output",
    "missing_evidence": "missing_evidence",
    "no_accepted_findings": "missing_evidence",
    "no_usable_evidence": "missing_evidence",
...
_STAGE_BY_TYPE: dict[str, str] = {
    ...
    "rate_limit": "worker",
    "server_error": "worker",
    "connection_error": "worker",
    "invalid_request": "worker",
    "usage_limit": "worker",
