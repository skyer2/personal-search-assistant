...
只输出 JSON：
{{"action":"CONDUCT_RESEARCH|COMPLETE","reason":"一句话说明","research_tasks":[{{"objective":"聚焦一个可验证研究缺口","target_criteria":["Brief success criterion"],"target_gaps":["上一轮仍未覆盖的具体缺口"],"priority":"high|normal|low","expected_evidence":["需要确认的事实类型"],"source_hints":["..."],"novelty_reason":"为什么不是重复任务","estimated_effort":"small|medium|large","max_search_queries":4,"max_llm_calls":4}}]}}
