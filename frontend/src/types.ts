...
export interface TraceSummary {
  ...
  latency?: {
    ...
    control_plane_ms?: number | null;
    control_plane_ratio?: number | null;
    stages?: Record<string, Record<string, unknown>>;
    substeps?: Record<string, Record<string, unknown>>;
    understand_ms?: number | null;
    intent_router_ms?: number | null;
    brief_plan_ms?: number | null;
    plan_validate_ms?: number | null;
